// mezura-real  13 lines 1 code 12 comment
// mezura-count 13 lines 1 code 12 comment
...
// between two paragraphs of documentation. Plain '//' and '/**/' on their own are counted
